...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(['vue'], e)
    : e((t = 'undefined' != typeof globalThis ? globalThis : t || self).Vue)
})(this, function (t) {
  'use strict'
  var e =
  ...
  function l() {
    ...
    for (
      ...
      (n[e] = t[e]), (r[t.charCodeAt(e)] = e)
    ;(r['-'.charCodeAt(0)] = 62), (r['_'.charCodeAt(0)] = 63)
  }
  function a(t, e, r) {
    for (var o, i = [], l = e; l < r; l += 3)
      i.push(
        n[((o = (t[l] << 16) + (t[l + 1] << 8) + t[l + 2]) >> 18) & 63] +
          n[(o >> 12) & 63] +
          n[(o >> 6) & 63] +
          n[63 & o]
      )
  ...
  function u(t) {
    ...
    i || l()
    for (
      var r = t.length, o = r % 3, u = '', s = [], c = 16383, f = 0, p = r - o;
      f < p;
      f += c
    )
      s.push(a(t, f, f + c > p ? p : f + c))
    return (
      1 === o
        ? ((u += n[(e = t[r - 1]) >> 2]), (u += n[(e << 4) & 63]), (u += '=='))
        : 2 === o &&
          ((u += n[(e = (t[r - 2] << 8) + t[r - 1]) >> 10]),
          (u += n[(e >> 4) & 63]),
          (u += n[(e << 2) & 63]),
          (u += '=')),
      s.push(u),
          ...
          if (e) {
            if (
              ...
              return 'number' != typeof e.length || (r = e.length) != r
                ? d(t, 0)
                : m(t, e)
            if ('Buffer' === e.type && p(e.data)) return m(t, e.data)
          }
          var r
          throw new TypeError(
  ...
  function g(t, e) {
    if ((b(e), (t = d(t, e < 0 ? 0 : 0 | _(e))), !y.TYPED_ARRAY_SUPPORT))
  ...
  function A(t, e, n, r, o) {
    ...
    if (('string' == typeof e && (e = y.from(e, r)), O(e)))
  ...
  ;(y.TYPED_ARRAY_SUPPORT =
    ...
    (y.compare = function (t, e) {
      if (!O(t) || !O(e)) throw new TypeError('Arguments must be Buffers')
      if (t === e) return 0
      for (
    ...
    (y.prototype.equals = function (t) {
      if (!O(t)) throw new TypeError('Argument must be a Buffer')
  ...
  function Y(t, e, n, r, o) {
    return o || K(t, 0, n, 4), c(t, e, n, r, 23, 4), n + 4
  }
  function V(t, e, n, r, o) {
    return o || K(t, 0, n, 8), c(t, e, n, r, 52, 8), n + 8
  }
  ;(y.prototype.slice = function (t, e) {
    ...
    if (
      ...
      (n = this.subarray(t, e)).__proto__ = y.prototype
    else {
      var o = e - t
      n = new y(o, void 0)
    ...
    (y.prototype.readFloatLE = function (t, e) {
      return e || U(t, 4, this.length), s(this, t, !0, 23, 4)
    }),
    (y.prototype.readFloatBE = function (t, e) {
      return e || U(t, 4, this.length), s(this, t, !1, 23, 4)
    }),
    (y.prototype.readDoubleLE = function (t, e) {
      return e || U(t, 8, this.length), s(this, t, !0, 52, 8)
    }),
    (y.prototype.readDoubleBE = function (t, e) {
      return e || U(t, 8, this.length), s(this, t, !1, 52, 8)
    }),
    ...
    (y.prototype.fill = function (t, e, n, r) {
      if ('string' == typeof t) {
        ...
        if ('string' == typeof r && !y.isEncoding(r))
      ...
      if (
        ...
        var l = O(t) ? t : G(new y(t, r).toString()),
          a = l.length
                  ...
                  (function i(u, h) {
                    ...
                    if (t(u, e)) d = new e()
                      ...
                      t(u, Error)
                        ? (d = Object.create(u))
                        : void 0 === s
                        ? ((v = Object.getPrototypeOf(u)),
                          (d = Object.create(v)))
                        : ((d = Object.create(s)), (v = s))
                    }
                    if (a) {
                      var b = f.indexOf(u)
                      if (-1 != b) return p[b]
  ...
  function it(t, e, n, r) {
          ...
          if ((null === c || c === f) && !(f < 0 || f > l)) {
            ...
            if ((y = e.slice(f)) === s) {
              ...
              if ((b = u.slice(0, h)) === (m = p.slice(0, h)))
                return dt(b, u.slice(h), p.slice(h), s)
            }
          }
          if (null === c || c === a) {
            var d = a,
        ...
        if (r.length > 0 && o && 0 === o.length) {
          ...
          if (!(l < (h = b.length) + (v = g.length))) {
            var m = e.slice(0, h),
              _ = e.slice(l - v)
            if (b === m && g === _)
              return dt(b, t.slice(h, i - v), e.slice(h, l - v), g)
          }
        }
        return null
      })(t, e, n)
      ...
      u = (function (t, e) {
        ...
        if (-1 !== i)
          return (
            ...
            t.length > e.length && (n[0][0] = n[2][0] = ot),
            n
          )
        if (1 === o.length)
          return [
        ...
        var l = (function (t, e) {
          ...
          function o(t, e, n) {
            for (
              ...
              var c = at(t.substring(n), e.substring(u)),
                f = ut(t.substring(0, n), e.substring(0, u))
              s.length < f + c &&
            ...
            for (var b = -v + p; b <= v - h; b += 2) {
              ...
              if (((a[g] = E), E > n)) h += 2
                ...
                if ((w = i + c - b) >= 0 && w < l && -1 !== u[w])
                  if (E >= (O = n - u[w])) return lt(t, e, E, m)
              }
            }
    ...
    return l && u.unshift([0, l]), a && u.push([0, a]), st(u, r), u
  }
  function lt(t, e, n, r) {
  ...
  function at(t, e) {
    ...
    for (var n = 0, r = Math.min(t.length, e.length), o = r, i = 0; n < o; )
      t.substring(i, o) == e.substring(i, o) ? (i = n = o) : (r = o),
        (o = Math.floor((r - n) / 2 + n))
    return ct(t.charCodeAt(o - 1)) && o--, o
  }
  function ut(t, e) {
    ...
    for (var n = 0, r = Math.min(t.length, e.length), o = r, i = 0; n < o; )
      ...
      e.substring(e.length - o, e.length - i)
        ...
        : (r = o),
        (o = Math.floor((r - n) / 2 + n))
    return ft(t.charCodeAt(t.length - o)) && o--, o
  }
  function st(t, e) {
    t.push([0, ''])
          ...
          case 0:
            ...
            if (l.length > 0 || a.length > 0) {
              ...
              0 === l.length && 0 === a.length
                ...
                : 0 === a.length
                ? (t.splice(r - f, f, [ot, l]), (r = r - f + 1))
                : (t.splice(r - f, f, [ot, l], [1, a]), (r = r - f + 2))
            }
            0 !== r && 0 === t[r - 1][0]
              ? ((t[r - 1][1] += t[r][1]), t.splice(r, 1))
              : r++,
  ...
  function pt(t) {
    return ft(t.charCodeAt(0))
  }
  function ht(t) {
    return ct(t.charCodeAt(t.length - 1))
  }
  function dt(t, e, n, r) {
    return ht(t) || pt(r)
      ? null
  ...
  ;(yt.INSERT = 1), (yt.DELETE = ot), (yt.EQUAL = 0)
  var vt = yt,
    bt = { exports: {} }
  !(function (t, e) {
    ...
    var C = 'object' == typeof self && self && self.Object === Object && self,
      L =
        ('object' == typeof tt && tt && tt.Object === Object && tt) ||
        C ||
  ...
  !(function (t, e) {
    ...
    ;(x['[object Float32Array]'] =
      ...
      (x[o] =
        ...
        x[g] =
          !1)
    var E = 'object' == typeof tt && tt && tt.Object === Object && tt,
    ...
    ;(t.compose = function (t, e, n) {
      ...
      (t.diff = function (t, e) {
        ...
        var n = Object.keys(t)
          ...
          .reduce(function (n, r) {
            return (
              xt.default(t[r], e[r]) || (n[r] = void 0 === e[r] ? null : e[r]),
              n
            )
          }, {})
        return Object.keys(n).length > 0 ? n : void 0
    ...
    Mt = (function () {
      ...
      return (
        ...
        (t.prototype.push = function (t) {
          var e = this.ops.length,
            n = this.ops[e - 1]
          if (((t = Tt.default(t)), 'object' == typeof n)) {
            ...
            if (
              ...
              return this.ops.unshift(t), this
            if (qt.default(t.attributes, n.attributes)) {
        ...
        (t.prototype.length = function () {
          return this.reduce(function (t, e) {
            return t + Lt.default.length(e)
          }, 0)
        }),
        (t.prototype.slice = function (e, n) {
          void 0 === e && (e = 0), void 0 === n && (n = 1 / 0)
          for (
            var r = [], o = Lt.default.iterator(this.ops), i = 0;
            i < n && o.hasNext();

          ) {
            var l = void 0
            i < e ? (l = o.next(e - i)) : ((l = o.next(n - i)), r.push(l)),
              (i += Lt.default.length(l))
          }
          return new t(r)
        }),
        (t.prototype.compose = function (e) {
          var n = Lt.default.iterator(this.ops),
            r = Lt.default.iterator(e.ops),
            o = [],
            i = r.peek()
          if (
            null != i &&
            ...
            if ('insert' === r.peekType()) a.push(r.next())
              ...
              if ('number' == typeof c.retain) {
                ...
                if (
                  (p && (f.attributes = p),
                  a.push(f),
                  !r.hasNext() && qt.default(a.ops[a.ops.length - 1], f))
                ) {
                  var h = new t(n.rest())
        ...
        (t.prototype.diff = function (e, n) {
          ...
          var r = [this, e].map(function (t) {
              return t
                .map(function (n) {
                  if (null != n.insert)
                    return 'string' == typeof n.insert ? n.insert : Rt
                  throw new Error(
                    'diff() called ' +
                      (t === e ? 'on' : 'with') +
                      ' non-document'
            ...
            l = Lt.default.iterator(this.ops),
            a = Lt.default.iterator(e.ops)
          return (
              ...
              for (var e = t[1].length; e > 0; ) {
                ...
                switch (t[0]) {
                  ...
                  case St.default.EQUAL:
                    ...
                    var r = l.next(n),
                      i = a.next(n)
                    qt.default(r.insert, i.insert)
                      ? o.retain(n, Ct.default.diff(r.attributes, i.attributes))
                      : o.push(i).delete(n)
                }
                e -= n
              }
        ...
        (t.prototype.eachLine = function (e, n) {
          void 0 === n && (n = '\n')
          for (
            var r = Lt.default.iterator(this.ops), o = new t(), i = 0;
            r.hasNext();

          ) {
            if ('insert' !== r.peekType()) return
            var l = r.peek(),
              a = Lt.default.length(l) - r.peekLength(),
        ...
        (t.prototype.invert = function (e) {
          ...
          return (
            this.reduce(function (t, r) {
              if (r.insert) n.delete(Lt.default.length(r))
              else {
                    ...
                    e.slice(t, t + o).forEach(function (t) {
                      r.delete
                        ...
                        : r.retain &&
                          ...
                          n.retain(
                            Lt.default.length(t),
                            Ct.default.invert(r.attributes, t.attributes)
                          )
                    }),
                    t + o
                  )
        ...
        (t.prototype.transform = function (e, n) {
          ...
          for (
            var r = e,
              o = Lt.default.iterator(this.ops),
              i = Lt.default.iterator(r.ops),
              l = new t();
            o.hasNext() || i.hasNext();
            ...
            if ('insert' !== o.peekType() || (!n && 'insert' === i.peekType()))
              if ('insert' === i.peekType()) l.push(i.next())
                ...
                s.delete
                  ...
                  : l.retain(
                      a,
                      Ct.default.transform(u.attributes, s.attributes, n)
                    )
              }
            else l.retain(Lt.default.length(o.next()))
          return l.chop()
        }),
        (t.prototype.transformPosition = function (t, e) {
          void 0 === e && (e = !1), (e = !!e)
          for (
            var n = Lt.default.iterator(this.ops), r = 0;
            n.hasNext() && r <= t;
  ...
  const It = {
    ...
    Bt = t.defineComponent({
      ...
      setup: (e, n) => {
              ...
              if (((o = a()), e.modules))
                if (Array.isArray(e.modules))
                  for (const t of e.modules)
                    rt.register(`modules/${t.name}`, t.module)
                else rt.register(`modules/${e.modules.name}`, e.modules.module)
              ;(r = new rt(i.value, o)),
                v(e.content),
                r.on('text-change', f),
                r.on('selection-change', h),
                r.on('editor-change', d),
                'bubble' !== e.theme && i.value.classList.remove('ql-bubble'),
                'snow' !== e.theme && i.value.classList.remove('ql-snow'),
        ...
        const c = (t) => {
          ...
          f = (t, r, o) => {
            ;(s = u(y())),
              c(e.content) || n.emit('update:content', s),
        ...
        const d = (...t) => {
          ...
          y = (t, n) =>
            'html' === e.contentType
              ...
              : r.getContents(t, n),
          v = (t, n = 'api') => {
            const o = t || ('delta' === e.contentType ? new Mt() : '')
            'html' === e.contentType
              ? _(o)
              : 'text' === e.contentType
              ? g(o, n)
        ...
        return (
          t.watch(
            ...
            (e) => {
              ...
              n && t.nextTick(() => (null == r ? void 0 : r.setSelection(n))),
                v(e)
            },
            { deep: !0 }
          ),
    ...
    Dt = t.createApp({ render: () => t.h('div', 'hello world!') })
  Dt.component('Editor', Bt), Dt.mount('#app')
})
