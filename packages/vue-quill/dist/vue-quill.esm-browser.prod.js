...
function h(t, e, n) {
  for (var r, o = [], i = e; i < n; i += 3)
    o.push(
      u[((r = (t[i] << 16) + (t[i + 1] << 8) + t[i + 2]) >> 18) & 63] +
        u[(r >> 12) & 63] +
        u[(r >> 6) & 63] +
        u[63 & r]
    )
...
function d(t) {
  ...
  f || p()
  for (
    var n = t.length, r = n % 3, o = '', i = [], l = 16383, a = 0, s = n - r;
    a < s;
    a += l
  )
    i.push(h(t, a, a + l > s ? s : a + l))
  return (
    1 === r
      ? ((o += u[(e = t[n - 1]) >> 2]), (o += u[(e << 4) & 63]), (o += '=='))
      : 2 === r &&
        ((o += u[(e = (t[n - 2] << 8) + t[n - 1]) >> 10]),
        (o += u[(e >> 4) & 63]),
        (o += u[(e << 2) & 63]),
        (o += '=')),
    i.push(o),
...
function _(t, e) {
  if (m() < e) throw new RangeError('Invalid typed array length')
  return (
...
function w(t, e, n, r) {
  ...
  return 'undefined' != typeof ArrayBuffer && e instanceof ArrayBuffer
    ...
    : (function (t, e) {
        if (j(e)) {
          var n = 0 | k(e.length)
          return 0 === (t = _(t, n)).length || e.copy(t, 0, 0, n), t
        }
        if (e) {
          if (
            ...
            return 'number' != typeof e.length || (r = e.length) != r
              ? _(t, 0)
              : A(t, e)
          if ('Buffer' === e.type && g(e.data)) return A(t, e.data)
        }
        var r
        throw new TypeError(
...
function E(t, e) {
  if ((x(e), (t = _(t, e < 0 ? 0 : 0 | k(e))), !O.TYPED_ARRAY_SUPPORT))
    for (var n = 0; n < e; ++n) t[n] = 0
  return t
}
function A(t, e) {
  var n = e.length < 0 ? 0 : 0 | k(e.length)
  t = _(t, n)
...
function T(t, e, n, r, o) {
  ...
  if (('string' == typeof e && (e = O.from(e, r)), j(e)))
    return 0 === e.length ? -1 : q(t, e, n, r, o)
  if ('number' == typeof e)
    return (
      (e &= 255),
...
function L(t, e, n, r) {
  return nt(tt(e, t.length - n), t, n, r)
}
function R(t, e, n, r) {
  return nt(
    (function (t) {
...
function D(t, e, n) {
  return d(0 === e && n === t.length ? t : t.slice(e, n))
}
function U(t, e, n) {
...
;(O.TYPED_ARRAY_SUPPORT =
  void 0 === a.TYPED_ARRAY_SUPPORT || a.TYPED_ARRAY_SUPPORT),
  m(),
  (O.poolSize = 8192),
  ...
  (O.prototype.compare = function (t, e, n, r, o) {
    if (!j(t)) throw new TypeError('Argument must be a Buffer')
    if (
      (void 0 === e && (e = 0),
...
function Z(t, e, n, r, o) {
  return o || G(t, 0, n, 4), v(t, e, n, r, 23, 4), n + 4
}
function X(t, e, n, r, o) {
  return o || G(t, 0, n, 8), v(t, e, n, r, 52, 8), n + 8
}
;(O.prototype.slice = function (t, e) {
  ...
  (O.prototype.readFloatLE = function (t, e) {
    return e || Y(t, 4, this.length), y(this, t, !0, 23, 4)
  }),
  (O.prototype.readFloatBE = function (t, e) {
    return e || Y(t, 4, this.length), y(this, t, !1, 23, 4)
  }),
  (O.prototype.readDoubleLE = function (t, e) {
    return e || Y(t, 8, this.length), y(this, t, !0, 52, 8)
  }),
  (O.prototype.readDoubleBE = function (t, e) {
    return e || Y(t, 8, this.length), y(this, t, !1, 52, 8)
  }),
  (O.prototype.writeUIntLE = function (t, e, n, r) {
    ;((t = +t), (e |= 0), (n |= 0), r) ||
      V(this, t, e, n, Math.pow(2, 8 * n) - 1, 0)
    var o = 1,
      i = 0
  ...
  (O.prototype.writeInt32LE = function (t, e, n) {
    return (
      (t = +t),
      (e |= 0),
      n || V(this, t, e, 4, 2147483647, -2147483648),
      O.TYPED_ARRAY_SUPPORT
        ? ((this[e] = 255 & t),
          (this[e + 1] = t >>> 8),
          (this[e + 2] = t >>> 16),
  ...
  (O.prototype.fill = function (t, e, n, r) {
    ...
    if (
      ...
      var l = j(t) ? t : tt(new O(t, r).toString()),
        a = l.length
...
function et(t) {
  return (function (t) {
    ...
    return (
      2 === i
        ? ((o = (s[t.charCodeAt(e)] << 2) | (s[t.charCodeAt(e + 1)] >> 4)),
          (l[u++] = 255 & o))
        : 1 === i &&
          ((o =
            (s[t.charCodeAt(e)] << 10) |
    ...
    return (function (t) {
      ...
      function (t, e, n) {
        ...
        var i = (function (t) {
          function e(e) {
            var n = this
            return (
              ((n = t.call(this, (e = '[Parchment] ' + e)) || this).message =
                e),
        ...
        ;(e.DATA_KEY = '__blot'),
          ...
          (e.register = function t() {
            ...
            if (
              ((c[r.blotName || r.attrName] = r), 'string' == typeof r.keyName)
            )
              a[r.keyName] = r
            else if (
              (null != r.className && (u[r.className] = r), null != r.tagName)
            ) {
      ...
      function (t, e, n) {
        ...
        ;(u.prototype.insert = function (t, e) {
          ...
          (u.prototype.eachLine = function (t, e) {
            ...
            for (
              ...
              var i = n.peek(),
                ...
                s =
                  'string' == typeof i.insert ? i.insert.indexOf(e, a) - a : -1
          ...
          (u.prototype.transform = function (t, e) {
            ...
            for (
              var n = l.iterator(this.ops), r = l.iterator(t.ops), o = new u();
              n.hasNext() || r.hasNext();
              ...
              if (
                ...
                if ('insert' === r.peekType()) o.push(r.next())
                  ...
                  s.delete
                    ...
                    : o.retain(
                        i,
                        l.attributes.transform(a.attributes, s.attributes, e)
                      )
                }
          ...
          _ = (function () {
            function t(e) {
              ...
              this.container.classList.add('ql-container'),
                ...
                this.theme.init(),
                this.emitter.on(u.default.events.EDITOR_CHANGE, function (t) {
      ...
      function (t, e, n) {
        var r = n(43),
          ...
          c = function (t, e) {
            ...
            for (var a = 0; a < i.length; a += 1) s(t, i[a], e[i[a]], n[i[a]])
          }
                    ...
                    if (
                      ...
                      if (!(i < 0 || i >= t + n)) {
                        var l = this.newlineIndex(t, !0) + 1,
                          ...
                          c = s.next
                        s.format(r, o),
                          c instanceof e && c.formatAt(0, t - l + n - u, r, o)
                      }
                    }
                  },
                },
                  ...
                  value: function (t) {
                    ...
                    return (
                      ...
                      (t = (function (t) {
                        ...
                        var s = l.retain || l.delete || l.insert.length || 1,
                          c = l.attributes || {}
                        if (null != l.insert) {
            ...
            function t(e, n) {
              ...
              f(this, t),
                ...
                this.emitter.listenDOM(
                  ...
                  function () {
                    r.mouseDown ||
                      setTimeout(r.update.bind(r, u.default.sources.USER), 1)
                  }
                ),
                this.emitter.on(
                  ...
                  value: function () {
                    ...
                    this.emitter.listenDOM(
                      ...
                      this.emitter.listenDOM(
                        ...
                        document.body,
                        function () {
                          ;(t.mouseDown = !1), t.update(u.default.sources.USER)
                        }
                      )
                  },
                },
              ...
              (function i(u, h) {
                ...
                if (t(u, e)) d = new e()
                  ...
                  t(u, Error)
                    ? (d = Object.create(u))
                    : void 0 === s
                    ? ((y = Object.getPrototypeOf(u)), (d = Object.create(y)))
                ...
                u)) {
                  var g
                  y && (g = Object.getOwnPropertyDescriptor(y, b)),
                    (g && null == g.set) || (d[b] = i(u[b], h - 1))
                }
                if (Object.getOwnPropertySymbols) {
                  var m = Object.getOwnPropertySymbols(u)
                  for (b = 0; b < m.length; b++) {
                    var _ = m[b]
                    ;(!(x = Object.getOwnPropertyDescriptor(u, _)) ||
                      x.enumerable ||
                      c) &&
                      ((d[_] = i(u[_], h - 1)),
                      x.enumerable ||
                        Object.defineProperty(d, _, { enumerable: !1 }))
                  }
                }
                if (c) {
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  if (
                    ...
                    if (a instanceof u.BlockEmbed || h instanceof u.BlockEmbed)
                  ...
                  value: function () {
                    ...
                    this.quill.root.addEventListener('keydown', function (n) {
                      if (!n.defaultPrevented) {
                        var i = (t.bindings[n.which || n.keyCode] || []).filter(
                          function (t) {
                            return e.match(n, t)
                          }
                        )
                              ...
                              if (Array.isArray(e.format)) {
                                ...
                                !Object.keys(e.format).every(function (t) {
                                  return !0 === e.format[t]
                                    ...
                                    : !1 === e.format[t]
                                    ? null == x.format[t]
                                    : (0, a.default)(e.format[t], x.format[t])
                                })
                              )
                                return !1
                              return !(
          ...
          if (!(t.index >= this.quill.getLength() - n)) {
            ...
            if (e.offset >= a.length() - 1) {
              ...
              if (s) {
                ...
                ;(r = c.default.attributes.diff(f, h) || {}), (i = s.length())
              }
            }
            ...
            bindings: {
              ...
              'checklist enter': {
                ...
                handler: function (t) {
                  var e = this.quill.getLine(t.index),
                    ...
                    r = n[0],
                    i = n[1],
                    l = (0, u.default)({}, r.formats(), { list: 'checked' }),
                    a = new s.default()
                      .retain(t.index)
                      .insert('\n', l)
                      .retain(r.length() - i - 1)
              ...
              'list autofill': {
                ...
                handler: function (t, e) {
                  ...
                  this.quill.insertText(t.index, ' ', p.default.sources.USER),
                    this.quill.history.cutoff()
                  var c = new s.default()
                    .retain(t.index - a)
                    .delete(n + 1)
      ...
      function (t, e, n) {
        ...
        var r,
          ...
          u = new i.default.Attributor.Class('direction', 'ql-direction', l),
      ...
      function (t, e, n) {
        t.exports = {
          align: { '': n(113), center: n(114), right: n(115), justify: n(116) },
          background: n(117),
          blockquote: n(118),
          bold: n(119),
          clean: n(120),
          ...
          float: { center: n(124), full: n(125), left: n(126), right: n(127) },
          formula: n(128),
                      ...
                      if (
                        ...
                        return (
                          null == t.querySelector('option') &&
                            A(t, m, 'background' === n ? '#ffffff' : '#000000'),
                          new c.default(t, e[n])
                        )
                      }
                      return (
            ...
            null != u &&
              (h = (function (t, e) {
                ...
                if (null != a && 0 === a[1].indexOf(l[1])) {
                  ...
                  return (
                    u.length > 0 && o.splice(i + 2, 0, [a[0], u]), s(o, i, 3)
                  )
                }
                return t
              })(h, u)),
      ...
      function (t, e, n) {
        var r = n(15),
          ...
          a = n(84),
          u = o(l(), Object)
        r(u, { getPolyfill: l, implementation: i, shim: a }), (t.exports = u)
      },
      function (t, e, n) {
        var r = n(50),
          o = n(15)
      ...
      function (t, e, n) {
        ...
        t.exports = function (t, e) {
          ...
          var n = arguments.length > 2 && !!arguments[2]
          return (n && !i) || (o ? r(t, 'name', e, !0, !0) : r(t, 'name', e)), t
        }
      },
      function (t, e, n) {
        var r = function () {
        ...
        ;(r.boundFunctionsHaveNames = function () {
          return (
            r() && 'function' == typeof i && '' !== function () {}.bind().name
          )
        }),
          (t.exports = r)
      },
      ...
      function (t, e, n) {
        ...
        var O = (0, c.default)('quill:clipboard'),
            ...
            [
              ...
              function (t, e) {
                ...
                for (
                  ...
                  'list' === (u.default.query(o) || {}).blotName && (r += 1),
                    (o = o.parentNode)
                return r <= 0
                  ? e
                  : e.compose(
          ...
          E = [p.AlignAttribute, v.DirectionAttribute].reduce(function (t, e) {
                  ...
                  value: function (t) {
                    ...
                    if (!t.defaultPrevented && this.quill.isEnabled()) {
                      ...
                      this.container.focus(),
                        this.quill.selection.update(s.default.sources.SILENT),
                        setTimeout(function () {
                          ;(r = r.concat(e.convert()).delete(n.length)),
                            e.quill.updateContents(r, s.default.sources.USER),
            ...
            function e(t, n) {
              ...
              return i.container instanceof HTMLElement
                ? (i.container.classList.add('ql-toolbar'),
                  ...
                  i)
                : ((o = p.error('Container required for toolbar', i.options)),
                  f(i, o))
            }
            return (
              (function (t, e) {
                      ...
                      t.addEventListener(
                        ...
                        function (o) {
                          ...
                          if ('SELECT' === t.tagName) {
                            ...
                            u = !s.hasAttribute('selected') && (s.value || !1)
                          } else
                            (u =
                          ...
                          var c = e.quill.selection.getRange(),
                            f = r(c, 1)[0]
                          if (null != e.handlers[n]) e.handlers[n].call(e, u)
                          else if (
                          ...
                          } else e.quill.format(n, u, a.default.sources.USER)
                          e.update(f)
                        }
                      ),
                      ...
                      if ('SELECT' === l.tagName) {
                        ...
                        if (null == t) a = null
                          ...
                          'string' == typeof u && (u = u.replace(/\"/g, '\\"')),
                            (a = l.querySelector('option[value="' + u + '"]'))
                        }
                        null == a
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      ...
                      o.bottom > r.bottom &&
                        ((this.root.style.top =
                          n - (t.bottom - t.top + (o.bottom - o.top)) + 'px'),
                  ...
                  if (
                    ...
                    if (1 === i.length) r.position(r.quill.getBounds(e))
                      ...
                      var a = i[i.length - 1],
                        ...
                        c = Math.min(a.length() - 1, e.index + e.length - u),
...
function ct(t, e, n, r) {
        ...
        if ((null === c || c === f) && !(f < 0 || f > l)) {
          ...
          if ((y = e.slice(f)) === s) {
            ...
            if ((b = u.slice(0, h)) === (m = p.slice(0, h)))
              return mt(b, u.slice(h), p.slice(h), s)
          }
        }
        if (null === c || c === a) {
          var d = a,
      ...
      if (r.length > 0 && o && 0 === o.length) {
        ...
        if (!(l < (h = b.length) + (v = g.length))) {
          var m = e.slice(0, h),
            _ = e.slice(l - v)
          if (b === m && g === _)
            return mt(b, t.slice(h, i - v), e.slice(h, l - v), g)
        }
      }
      return null
    })(t, e, n)
  ...
  var i = pt(t, e),
    l = t.substring(0, i)
  i = ht((t = t.substring(i)), (e = e.substring(i)))
    ...
    u = (function (t, e) {
      ...
      if (-1 !== i)
        return (
          ...
          t.length > e.length && (n[0][0] = n[2][0] = -1),
          n
        )
      if (1 === o.length)
        return [
      ...
      var l = (function (t, e) {
        ...
        function o(t, e, n) {
          for (
            ...
            var c = pt(t.substring(n), e.substring(u)),
              f = ht(t.substring(0, n), e.substring(0, u))
            s.length < f + c &&
          ...
          for (var b = -v + p; b <= v - h; b += 2) {
            ...
            if (((a[g] = E), E > n)) h += 2
              ...
              if ((w = i + c - b) >= 0 && w < l && -1 !== u[w])
                if (E >= (O = n - u[w])) return ft(t, e, E, m)
            }
          }
  ...
  return l && u.unshift([0, l]), a && u.push([0, a]), dt(u, r), u
}
function ft(t, e, n, r) {
...
function pt(t, e) {
  ...
  for (var n = 0, r = Math.min(t.length, e.length), o = r, i = 0; n < o; )
    t.substring(i, o) == e.substring(i, o) ? (i = n = o) : (r = o),
      (o = Math.floor((r - n) / 2 + n))
  return yt(t.charCodeAt(o - 1)) && o--, o
}
function ht(t, e) {
  ...
  for (var n = 0, r = Math.min(t.length, e.length), o = r, i = 0; n < o; )
    ...
    e.substring(e.length - o, e.length - i)
      ...
      : (r = o),
      (o = Math.floor((r - n) / 2 + n))
  return vt(t.charCodeAt(t.length - o)) && o--, o
}
function dt(t, e) {
  t.push([0, ''])
        ...
        case 0:
          ...
          if (l.length > 0 || a.length > 0) {
            ...
            0 === l.length && 0 === a.length
              ...
              : 0 === a.length
              ? (t.splice(r - f, f, [-1, l]), (r = r - f + 1))
              : (t.splice(r - f, f, [-1, l], [1, a]), (r = r - f + 2))
          }
          0 !== r && 0 === t[r - 1][0]
            ? ((t[r - 1][1] += t[r][1]), t.splice(r, 1))
            : r++,
...
function gt(t) {
  return yt(t.charCodeAt(t.length - 1))
}
function mt(t, e, n, r) {
  return gt(t) || bt(r)
    ? null
...
;(_t.INSERT = 1), (_t.DELETE = -1), (_t.EQUAL = 0)
var Ot = _t,
  wt = { exports: {} }
!(function (t, e) {
  ...
  var C = 'object' == typeof self && self && self.Object === Object && self,
    L =
      ('object' == typeof it && it && it.Object === Object && it) ||
      C ||
  ...
  var Y,
    ...
    et = I ? L.Buffer : void 0,
    nt = L.Symbol,
    rt = L.Uint8Array,
    ot = z(Object.getPrototypeOf, Object),
    lt = Object.create,
...
!(function (t, e) {
  ...
  ;(x['[object Float32Array]'] =
    ...
    (x[o] =
      ...
      x[g] =
        !1)
  var E = 'object' == typeof it && it && it.Object === Object && it,
  ...
  ;((nt && Ct(new nt(new ArrayBuffer(1))) != _) ||
    (rt && Ct(new rt()) != c) ||
    (ot && Ct(ot.resolve()) != h) ||
    (lt && Ct(new lt()) != y) ||
    (at && Ct(new at()) != g)) &&
  ...
  ;(t.compose = function (t, e, n) {
    ...
    (t.diff = function (t, e) {
      ...
      var n = Object.keys(t)
        ...
        .reduce(function (n, r) {
          return (
            Nt.default(t[r], e[r]) || (n[r] = void 0 === e[r] ? null : e[r]), n
          )
        }, {})
      return Object.keys(n).length > 0 ? n : void 0
    }),
  ...
  Ft = (function () {
    ...
    return (
      ...
      (t.prototype.push = function (t) {
        var e = this.ops.length,
          n = this.ops[e - 1]
        if (((t = Mt.default(t)), 'object' == typeof n)) {
          if ('number' == typeof t.delete && 'number' == typeof n.delete)
            return (this.ops[e - 1] = { delete: n.delete + t.delete }), this
          if (
            'number' == typeof n.delete &&
            ...
            return this.ops.unshift(t), this
          if (It.default(t.attributes, n.attributes)) {
            if ('string' == typeof t.insert && 'string' == typeof n.insert)
              return (
                (this.ops[e - 1] = { insert: n.insert + t.insert }),
                'object' == typeof t.attributes &&
      ...
      (t.prototype.length = function () {
        return this.reduce(function (t, e) {
          return t + Dt.default.length(e)
        }, 0)
      }),
      (t.prototype.slice = function (e, n) {
        void 0 === e && (e = 0), void 0 === n && (n = 1 / 0)
        for (
          var r = [], o = Dt.default.iterator(this.ops), i = 0;
          i < n && o.hasNext();

        ) {
          var l = void 0
          i < e ? (l = o.next(e - i)) : ((l = o.next(n - i)), r.push(l)),
            (i += Dt.default.length(l))
        }
        return new t(r)
      }),
      (t.prototype.compose = function (e) {
        var n = Dt.default.iterator(this.ops),
          r = Dt.default.iterator(e.ops),
          o = [],
          i = r.peek()
          ...
          if ('insert' === r.peekType()) a.push(r.next())
            ...
            if ('number' == typeof c.retain) {
              ...
              if (
                (p && (f.attributes = p),
                a.push(f),
                !r.hasNext() && It.default(a.ops[a.ops.length - 1], f))
              ) {
                var h = new t(n.rest())
      ...
      (t.prototype.diff = function (e, n) {
        ...
        var r = [this, e].map(function (t) {
            return t
              .map(function (n) {
                if (null != n.insert)
                  return 'string' == typeof n.insert ? n.insert : Ut
                throw new Error(
          ...
          o = new t(),
          i = Rt.default(r[0], r[1], n),
          l = Dt.default.iterator(this.ops),
          a = Dt.default.iterator(e.ops)
        return (
          i.forEach(function (t) {
            for (var e = t[1].length; e > 0; ) {
              var n = 0
              switch (t[0]) {
                case Rt.default.INSERT:
                  ;(n = Math.min(a.peekLength(), e)), o.push(a.next(n))
                  break
                case Rt.default.DELETE:
                  ;(n = Math.min(e, l.peekLength())), l.next(n), o.delete(n)
                  break
                case Rt.default.EQUAL:
                  n = Math.min(l.peekLength(), a.peekLength(), e)
                  var r = l.next(n),
                    i = a.next(n)
                  It.default(r.insert, i.insert)
                    ? o.retain(n, Bt.default.diff(r.attributes, i.attributes))
                    : o.push(i).delete(n)
              }
              e -= n
            }
      ...
      (t.prototype.eachLine = function (e, n) {
        void 0 === n && (n = '\n')
        for (
          var r = Dt.default.iterator(this.ops), o = new t(), i = 0;
          r.hasNext();

        ) {
          if ('insert' !== r.peekType()) return
          var l = r.peek(),
            a = Dt.default.length(l) - r.peekLength(),
      ...
      (t.prototype.invert = function (e) {
        ...
        return (
          this.reduce(function (t, r) {
            if (r.insert) n.delete(Dt.default.length(r))
            else {
                  ...
                  e.slice(t, t + o).forEach(function (t) {
                    r.delete
                      ...
                      : r.retain &&
                        ...
                        n.retain(
                          Dt.default.length(t),
                          Bt.default.invert(r.attributes, t.attributes)
                        )
                  }),
                  t + o
                )
      ...
      (t.prototype.transform = function (e, n) {
        ...
        for (
          var r = e,
            o = Dt.default.iterator(this.ops),
            i = Dt.default.iterator(r.ops),
            l = new t();
          o.hasNext() || i.hasNext();
          ...
          if ('insert' !== o.peekType() || (!n && 'insert' === i.peekType()))
            if ('insert' === i.peekType()) l.push(i.next())
              ...
              s.delete
                ...
                : l.retain(
                    a,
                    Bt.default.transform(u.attributes, s.attributes, n)
                  )
            }
          else l.retain(Dt.default.length(o.next()))
        return l.chop()
      }),
      (t.prototype.transformPosition = function (t, e) {
        void 0 === e && (e = !1), (e = !!e)
        for (
          var n = Dt.default.iterator(this.ops), r = 0;
          n.hasNext() && r <= t;
...
const Ht = {
  ...
  zt = t({
    ...
    setup: (t, l) => {
            ...
            if (((u = f()), t.modules))
              if (Array.isArray(t.modules))
                for (const e of t.modules)
                  st.register(`modules/${e.name}`, e.module)
              else st.register(`modules/${t.modules.name}`, t.modules.module)
            ;(a = new st(s.value, u)),
              _(t.content),
              a.on('text-change', y),
              a.on('selection-change', b),
              a.on('editor-change', g),
              'bubble' !== t.theme && s.value.classList.remove('ql-bubble'),
              'snow' !== t.theme && s.value.classList.remove('ql-snow'),
              null === (e = a.getModule('toolbar')) ||
                void 0 === e ||
            ...
            const n = (() => {
              ...
              if (Array.isArray(t.modules))
                for (const o of t.modules)
                  r[o.name] = null !== (e = o.options) && void 0 !== e ? e : {}
              else
                r[t.modules.name] =
      ...
      let h
      const d = (t) => {
          if (typeof h == typeof t) {
            if (t === h) return !0
            if ('object' == typeof t && t && 'object' == typeof h && h)
              return (
                (e = h.diff(t)),
        ...
        y = (e, n, r) => {
          ;(h = p(m())),
            d(t.content) || l.emit('update:content', h),
            l.emit('textChange', { delta: e, oldContents: n, source: r })
        },
        v = r(),
        b = (t, e, n) => {
          ;(v.value = !!(null == a ? void 0 : a.hasFocus())),
            l.emit('selectionChange', { range: t, oldRange: e, source: n })
        }
      o(v, (t) => {
        l.emit(t ? 'focus' : 'blur', s)
      })
      const g = (...t) => {
          'text-change' === t[0] &&
            l.emit('editorChange', {
        ...
        m = (e, n) =>
          'html' === t.contentType
            ...
            : a.getContents(e, n),
        _ = (e, n = 'api') => {
          const r = e || ('delta' === t.contentType ? new Ft() : '')
          'html' === t.contentType
            ? E(r)
            : 'text' === t.contentType
            ? w(r, n)
            : null == a || a.setContents(r, n),
            (h = p(r))
        },
        O = (t, e) => {
          var n
          return null !== (n = null == a ? void 0 : a.getText(t, e)) &&
            void 0 !== n
            ? n
            : ''
        },
        w = (t, e = 'api') => {
          null == a || a.setText(t, e)
        },
        x = () => {
          var t
          return null !== (t = null == a ? void 0 : a.root.innerHTML) &&
            void 0 !== t
            ? t
            : ''
        },
        E = (t) => {
          a && (a.root.innerHTML = t)
        }
      return (
        o(
          () => t.content,
          (t) => {
            if (!a || !t || d(t)) return
            const e = a.getSelection()
            e && i(() => (null == a ? void 0 : a.setSelection(e))), _(t)
          },
          { deep: !0 }
        ),
        o(
        ...
        ),
        {
          ...
          getToolbar: () => {
            var t
            return null === (t = null == a ? void 0 : a.getModule('toolbar')) ||
              void 0 === t
              ? void 0
              : t.container
          },
          ...
          setHTML: E,
          pasteHTML: (t, e = 'api') => {
            const n = null == a ? void 0 : a.clipboard.convert(t)
            n && (null == a || a.setContents(n, e))
          },
          focus: () => {
            null == a || a.focus()
          },
...
export { Ft as Delta, st as Quill, zt as QuillEditor }
